...
export class GoogleTokenVerifier {
    ...
    async verifyToken(idToken: string): Promise<any> {
        ...
        const ticket = await this.oAuth2Client.verifyIdToken({
            idToken,
            audience: ["211478218917-v2030povbi095htul9hfomvc4tmp31gb.apps.googleusercontent.com", "211478218917-ptmvmr61q37lnfcigbp34e1k0eegmmfi.apps.googleusercontent.com"],
        });
